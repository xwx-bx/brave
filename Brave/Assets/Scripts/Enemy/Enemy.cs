...
public class Enemy : Entity
{
    ...
    public virtual void AnimationSpecialAttaackTrigger()
    {
    ...
    public virtual RaycastHit2D IsPlayerDetected()
    {
        ...
        RaycastHit2D wallDetected = Physics2D.Raycast(wallCheck.position, Vector2.right * facingDir, .1f, whatIsGround);
