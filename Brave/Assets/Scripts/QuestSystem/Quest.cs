...
public class Quest 
{
    ...
    public Quest(QuestInfoSO questInfo, QuestState questState,int currentQuestStepIndex, QuestStepState[] questStepStates)
    {
        ...
        {
            Debug.LogError("Quest Step Prefabs and Quest Step States are "
    ...
    public void StoreQuestStepState(QuestStepState questStepState, int stepIndex)
    {
        ...
        {
            Debug.LogWarning("Tried to access quest step state, but stepIndex was out of range: "
                + "QuestId = " + info.id + ", stepIndex = " + stepIndex);
        }
    }
