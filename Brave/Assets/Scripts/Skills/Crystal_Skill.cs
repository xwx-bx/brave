...
public class Crystal_Skill : Skill
{
    ...
    public GameObject getCurrentCrystal() => currentCrystal;
    ...
    public override void UseSkill()
    {
        ...
        else
        {
            ...
            {
                currentCrystal.GetComponent<Crystal_Skill_Controller>()?.FinishCrystsl();
            }
        }
    ...
    private void ResetAbility()
    {
        ...
        RefilCrystal();
        uiInGame.SetCooldownOfCrystalImage();
    }
}
