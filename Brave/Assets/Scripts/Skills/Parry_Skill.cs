...
public class Parry_Skill : Skill
{
    ...
    [SerializeField] private UI_SkillTreeSlot restoreParryButton;
    [Range(0f, 1f)]
    ...
    protected override void Start()
    {
        ...
        restoreParryButton.GetComponent<Button>().onClick.AddListener(UnlockParryRestore);
    ...
    {
        if (restoreParryButton.unlocked)
