...
public class CharacterStats : MonoBehaviour
{
    ...
    private void AttemptyToApplyAilments(CharacterStats _targetStats, int _fireDamage, int _iceDamage, int _lightingDamage)
    {
        ...
        {
            if (Random.value < .333333f && _fireDamage > 0)
            {
                canApplyIgnite = true;
    ...
    private void ApplyIgniteDamage()
    {
        ...
        {
            DeccreaseHealthBy(igniteDamage);
    ...
    public virtual void DeccreaseHealthBy(int _damage)
    {
        if (isVulnerable)
